...
const databaseUrl = 'mongodb+srv://miko:miko@cluster0.ruowy.mongodb.net/?retryWrites=true&w=majority'
const databaseAdapter = /https?:\/\//.test('mongodb+srv://miko:miko@cluster0.ruowy.mongodb.net/?retryWrites=true&w=majority') ?
  new cloudDBAdapter('mongodb+srv://miko:miko@cluster0.ruowy.mongodb.net/?retryWrites=true&w=majority') : /mongodb(\+srv)?:\/\//i.test('mongodb+srv://miko:miko@cluster0.ruowy.mongodb.net/?retryWrites=true&w=majority') ?
    (Helper.opts['mongodbv2'] ? new mongoDBV2(databaseUrl) :
      new mongoDB('mongodb+srv://miko:miko@cluster0.ruowy.mongodb.net/?retryWrites=true&w=majority')) :
    new JSONFile(`${'mongodb+srv://miko:miko@cluster0.ruowy.mongodb.net/?retryWrites=true&w=majority'}database.json`)
